        ...
        <table class="table">
            ...
            <tbody>
                @forelse ($acknowledgementReceipts as $acknowledgementReceipt)
                    <tr>
                        <td>
                            <a href="{{ route("agent.acknowledgement-receipt.show", $acknowledgementReceipt) }}">
                        ...
                        <td class="text-end">
                            <a href="{{ route('agent.acknowledgement-receipt.show', $acknowledgementReceipt) }}" class="btn-sm btn-primary py-0 btn text-white px-2"> <i class="fa fa-eye"></i> Show</a>
                        </td>
                    </tr>
