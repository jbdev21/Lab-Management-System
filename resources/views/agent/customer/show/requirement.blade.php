        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="shadow-sm p-2">
                    <form action="{{ route("agent.customer.add.attachment", $customer) }}" method="POST" enctype="multipart/form-data" class="overlayed-form">
                        @csrf
                        <div class="mb-3">
                    ...
                    <tbody>
                        @forelse ($attachments as $attachment)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route("agent.attachment.download", $attachment) }}" class="btn-sm btn-primary py-0 btn text-white px-2">
                                    ...
                                    <form id="delete-{{ $attachment->id }}" action="{{ route('agent.attachment.destroy', $attachment->id) }}" method="POST">@csrf @method('DELETE')</form>
                                </td>
                            </tr>
                        @empty
                            <tr>
