                        ...
                        <div class="app-card-body">
                            <form action="{{ route('dashboard.department.update', $department->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control mb-2" name="name" value="{{ $department->name }}" required>
                                </div>

                                <button type="submit" class="btn btn-primary text-white mt-3"><i class="fa fa-save"></i> Save Changes</button>
                                <a href="{{ route('dashboard.department.index') }}" class="btn btn-secondary text-white mt-3"><i class="fa fa-ban"></i> Cancel</a>
                            </form>
                        </div>
                    </div>
                </div><!--//col-->
