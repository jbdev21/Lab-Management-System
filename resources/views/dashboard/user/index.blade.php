                            ...
                            <div class="app-card-body p-4">
                                ...
                                @csrf
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control mb-2" name="name" value="{{  old("name") }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Email</label>
                                        <input type="email" class="form-control mb-2" name="email" value="{{  old("email") }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Address</label>
                                        <input type="text" class="form-control mb-2" name="address" value="{{  old("address") }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Contact</label>
                                        <input type="text" class="form-control mb-2" name="contact_number" value="{{  old("contact_number") }}" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control mb-2" name="position" value="{{  old("position") }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="">Username</label>
                                        <input type="text" class="form-control mb-2" name="username" value="{{  old("username") }}" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="role" class="form-control">
                                            @foreach($roles as $role)
                                                <option @selected($role->id == old("role")) value="{{ $role->id }}">{{ $role->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <tbody>
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            @can("manage users")
                                                <a href="{{ route('dashboard.user.edit', $user->id) }}" class="btn-sm btn-primary py-0 btn text-white px-2"> <i class="fa fa-pencil"></i></a>
                                                ...
                                                <form id="delete-{{ $user->id }}" action="{{ route('dashboard.user.destroy', $user->id) }}" method="POST">@csrf @method('DELETE')</form>
                                            @endcan
                                        </td>
                                    </tr>
